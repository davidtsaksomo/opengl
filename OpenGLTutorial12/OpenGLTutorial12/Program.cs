...
namespace OpenGLTutorial12
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < particleCount; i++) particles.Add(new Particle(new Vector3((float)generator.NextDouble() * 200 - 100, 6, 0), 0));
        ...
        private static void OnRenderFrame()
        {
            ...
            for (int i = 0; i < particles.Count; i++)
            {
                ...
                if (particles[i].Life < 0) particles[i] = new Particle(new Vector3((float)generator.NextDouble() * 200 - 100, 6, 0));
